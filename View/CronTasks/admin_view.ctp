...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete %s', __('Cron Task')), array('action' => 'delete', $cronTask['CronTask']['id']), null, __('Are you sure you want to delete # %s?', $cronTask['CronTask']['id'])); ?> </li>
