...
/**
 * A Simple QueueTask example with callbacks.
 *
 */
class QueueCallbacksTask extends QueueTask {
...
/**
 * Stores a value from the after callback
 *
 * @var string
 */
	public $after = null;
 ...
 */
	public function add() {
		 ...
		 */
		if ($this->QueuedTask->createJob('Callbacks', null)) {
 ...
 */
	...
	public function afterRun( $data, $id ) {
		$this->after = true;
		return;
	}
}
