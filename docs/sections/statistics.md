...
But if you want to browse the statistics via URL, you can enable the routing for it (see [Basic Setup](sections/basic_setup.md)) and then access `/admin/queue`
