...
By default the suite uses SQLite (works out of the box). Not all tests run on
SQLite or other non-MySQL databases yet. To run the full suite including the
MySQL-only tests:
...
Make sure the `cake_test` database exists.
